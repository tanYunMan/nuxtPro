<template>
  ...
  <div class="usercenter-nav">
  	<div class="userimgbox">
  		<a href="/personal-center" class="updateimg">
  			<img :srcset="site.logo" title="头像">
  		</a>
  		<div class="userinfobox" style="padding: 10px 0px;width: 130px;min-width: 130px;">

  		</div>
  		<div class="usercenter-money-body">
  			<a class="layui-btn layui-btn-sm" href="/charge2">我要充值</a>
  			<a class="layui-btn layui-btn-sm" href="/wallet2">我的余额</a>
  		</div>


  	</div>
  	<div class="usercenter-nav-items">
  		<h3 @click="test"><i class='iconfont icon-huiyuanzhongxin2'></i>会员中心</h3>


  		<ul>
  			<li> <a href="/my-information">个人资料</a></li>
  			<li> <a href="/security-settings">安全设置</a></li>
  			<li> <a href="/category-list2">购买商品</a></li>
  			<li> <a href="/goods-list2">商品推荐</a></li>
  			<li> <a href="/recharge-record">充值记录</a></li>
  			<li> <a href="/my-order">订单记录</a></li>
  			<li> <a href="/details-funds">资金明细</a></li>
  			<li> <a href="/list-complaints">投诉列表</a></li>
  			<li> <a href="javascript:void(0)" @click="$refs.vip.show()">提升等级</a></li>
  			<li> <a href="javascript:void(0)" @click="$refs.self.show()">加设Vip站</a></li>
  			<li> <a href="/withdrawal-application">我要提现</a></li>
  		</ul>
  	</div>
  </div>
...
.usercenter-nav-items ul li a:hover {
	color: #1E9FFF;
}
