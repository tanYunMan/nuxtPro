          ...
          <ul>
            ...
            <li>
              ...
              <p>
				...
				<!-- 	<div class="common-usercenter-box" style="height: 515px;">
					<div class="common-items-header">
						<h6 class="common-title">修改登录密码</h6>
					</div>
					<div class="user-upsafe-pwd" style="margin-top: 30px;">
						<form action="" class="layui-form" onsubmit="return false;">
							<div class="layui-form-item">
								<label class="layui-form-label">原登录密码</label>
								<div class="layui-input-block" style="width: 300px;">
									<input type="password" name="password"" id="Joldpwd" required  lay-verify="required|password" placeholder="请输入原登录密码" autocomplete="off" class="layui-input">
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">新登录密码</label>
								<div class="layui-input-block" style="width: 300px;">
									<input type="password" name="newpassword" id="Jnewpwd" required  lay-verify="required|newpassword" placeholder="请输入新登录密码" autocomplete="off" class="layui-input">
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">重复新密码</label>
								<div class="layui-input-block" style="width: 300px;">
									<input type="password" name="repassword" id="Jrepwd" required  lay-verify="required|repassword" placeholder="请再次输入新登录密码" autocomplete="off" class="layui-input">
								</div>
							</div>
							<div class="layui-form-item">
								<div class="layui-input-block">
									<button class="layui-btn layui-btn-normal" lay-submit lay-filter="modifypwd">确认修改</button>
								</div>
							</div>
						</form>
					</div>
...
section {
  ...
  .el-button--primary{
        ...
        border-color: #409EFF;text-align: center;
