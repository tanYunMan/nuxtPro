...
<div class="usercenter-box" style="background-color:#FFFFFF; ">
		...
		<div class="common-items-header">
			<h6 class="common-title">用户等级提升</h6>
		</div>

		<div class="myorderbox common-form-set">
			<form action="" class="layui-form" onsubmit="return false;">
				<div class="layui-form-item">
					<label class="layui-form-label">用户当前等级</label>
					<div class="layui-form-mid layui-word-aux"><span style="color: #000;">平台老用户</span></div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">选择提升等级</label>
					<div class="layui-input-inline" style="width: 300px;">
						<select name="grade" lay-verify="required" lay-filter="userGrade" class="userGrade">
							<option value="1" data-price="188.00">全网最低(密价)</option>						</select><div class="layui-unselect layui-form-select"><div class="layui-select-title"><input type="text" placeholder="请选择" value="全网最低(密价)" readonly="" class="layui-input layui-unselect"><i class="layui-edge"></i></div><dl class="layui-anim layui-anim-upbit"><dd lay-value="1" class="layui-this">全网最低(密价)</dd></dl></div>
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">升级所需费用</label>
					<div class="layui-form-mid layui-word-aux"><span class="color-red user-need-price">188.00</span>元</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-input-block">
						<button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="sureGrade">确认升级</button>
					</div>
				</div>
			</form>
		</div>
