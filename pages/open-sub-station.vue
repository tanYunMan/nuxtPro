	...
	<div class="usercenter-box">
			    <div class="usercenter-box">
			        <div class="common-usercenter-box">
			            <h6 class="common-title">开通分站</h6>
			            <div class="myorderbox common-form-set">
			                <form action="" class="layui-form">
			                    <div class="layui-form-item">
			                        <label class="layui-form-label">客户编号</label>
			                        <div class="layui-input-inline" style="width:570px;">
			                            <input type="text" name="uid" required="" lay-verify="required" value="56568" autocomplete="off" class="layui-input layui-disabled" readonly="" disabled="">
			                        </div>
			                    </div>
			                    <div class="layui-form-item">
			                        ...
			                        <div class="layui-input-inline" style="color: red; ">如果上级用户级别低于或者等于赠送级别，当前用户的上级将自动解绑,如果用户级别高于赠送级别，用户级别不变！</div>
			                    </div>
			                    <div class="layui-form-item">
			                        ...
			                        <div class="layui-input-inline" style="width:252px;">
			                            <input type="text" name="qz" required="" lay-verify="required" data-length="1-10" placeholder="请输入二级域名前缀" autocomplete="off" class="layui-input">
			                        </div>
			                        <div class="layui-input-inline" style="width:260px;">
			                            <select name="hz"></select><div class="layui-unselect layui-form-select"><div class="layui-select-title"><input type="text" placeholder="请选择" value="" readonly="" class="layui-input layui-unselect"><i class="layui-edge"></i></div><dl class="layui-anim layui-anim-upbit"><dd lay-value="" class="layui-disabled">没有选项</dd></dl></div>
			                        </div>
			                    </div>
			                    <div class="layui-form-item">
			                        <label class="layui-form-label">网站名称</label>
			                        <div class="layui-input-inline" style="width:570px;">
			                            <input type="text" name="site_name" required="" lay-verify="required" placeholder="请输入网站名称" autocomplete="off" class="layui-input">
			                        </div>
			                    </div>
			                    <div class="layui-form-item">
			                        <label class="layui-form-label">网站风格</label>
			                        <div class="layui-input-inline" style="width:570px;">
			                            <select name="vip_style">
			                                <option value="default">默认</option>
			                            </select><div class="layui-unselect layui-form-select"><div class="layui-select-title"><input type="text" placeholder="请选择" value="默认" readonly="" class="layui-input layui-unselect"><i class="layui-edge"></i></div><dl class="layui-anim layui-anim-upbit"><dd lay-value="default" class="layui-this">默认</dd></dl></div>
			                        </div>
			                    </div>
			
			                    <div class="layui-form-item">
			                        <label class="layui-form-label">搭建扣费</label>
			                        <div class="layui-input-inline" style="width:570px;">
			                            <input type="text" name="money" required="" lay-verify="required" value="" autocomplete="off" class="layui-input show-price" readonly="" disabled="" style="color: red;">
			                        </div>
			                    </div>
			                    <div class="layui-form-item">
			                        <label class="layui-form-label">交易密码</label>
			                        <div class="layui-input-inline" style="width:570px;">
			                            <input type="password" name="trade_password" required="" lay-verify="required" value="" placeholder="请输入您的交易密码默认123123" autocomplete="off" class="layui-input">
			                        </div>
			                    </div>
			                    <div class="layui-form-item">
			                        <label class="layui-form-label"></label>
			                        <div class="layui-input-inline">
			                            <button class="layui-btn layui-btn-sm" lay-submit="" lay-filter="submit">确认开通</button>
			                        </div>
			                    </div>
			                </form>
			            </div>
