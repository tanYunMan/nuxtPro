    ...
    <div class="common-container usercenter-container">
      ...
      <div class="usercenter-box">
        ...
        <div class="filter">
          ...
          <select-filter ref="s1" name="查询条件" :options="selectOptions"></select-filter>
          <check-filter ref="c1" name="支付状态" :options="checkOptions"></check-filter>
          <check-filter ref="c2" name="支付方式" :options="payOptions"></check-filter>
        ...
        <section>
          <el-table v-loading="isLoading" :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="paySn" label="商户单号" width="210"></el-table-column>
          ...
          <el-pagination background layout="prev, pager, next, jumper" :page-size="query.pageSize" :total="dataTotal"
