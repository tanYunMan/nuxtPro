			            ...
			            <form action="" class="layui-form" onsubmit="return false;">
			                <div class="layui-form-item">
			                    ...
			                    <div class="layui-input-inline" style="width:185px;">
			                        <input type="text" name="mobile" value="" autocomplete="off" class="layui-input phone-number" lay-verify="required|phone" placeholder="请输入您的手机号码" data-code="no">
			                    </div>
			                    <div class="layui-input-inline" style="width:auto;">
			                        <button class="layui-btn layui-btn-sm getPhoneCodeBtn" type="button" style="width: 135px;">获取验证码</button>
			                    </div>
			                </div>
			                ...
			                <div class="layui-form-item">
			                    ...
			                    <div class="layui-input-inline" style="width:330px;">
			                        <input type="text" name="code" required="" lay-verify="required|number" value="" placeholder="请输入手机验证码" autocomplete="off" class="layui-input phonecode-number">
			                    </div>
			                </div>
			                <div class="layui-form-item">
			                    <div class="layui-input-block">
			                        <button class="layui-btn layui-btn-sm" lay-submit="" lay-filter="bindPhone">绑定手机</button>
			                    </div>
			                </div>
			            </form>
			        </div>
