  ...
  <div>
		...
		<div class="common-container usercenter-container">
			...
			<div class="usercenter-box"> 
				...
				<div class="common-items-header"> 
					<div class="layui-btn-group">
			            <a class="layui-btn layui-btn-normal layui-btn-sm" href="/ucenter/smsSend.html">短信发送</a>
			        </div>
					<div class="myorderbox common-form-set">
							<div class="layui-tab layui-tab-brief tradeorderbox" lay-filter="docDemoTabBrief">
								<ul class="layui-tab-title">
									<li class="layui-this"><a href="/ucenter/smsoutbox/group_id/1.html">收件箱</a></li><li><a href="/ucenter/smsinbox/group_id/2.html">发件箱</a></li>					</ul>
								<div class="layui-tab-content">
									<div class="layui-tab-item layui-show">
										<form class="layui-form layui-form-horizontal" onsubmit="return false;">
											...
											<div class="layui-inline">
												...
												<div class="layui-input-inline">
													<select name="_status">
														...
														<option value="0">未读</option><option value="1">已读未回复</option><option value="2">已读已回复</option>										</select><div class="layui-unselect layui-form-select"><div class="layui-select-title"><input type="text" placeholder="全部" value="" readonly="" class="layui-input layui-unselect"><i class="layui-edge"></i></div><dl class="layui-anim layui-anim-upbit"><dd lay-value="" class="layui-select-tips">全部</dd><dd lay-value="0" class="">未读</dd><dd lay-value="1" class="">已读未回复</dd><dd lay-value="2" class="">已读已回复</dd></dl></div>
												</div>
												<div class="layui-inline">
				...
				<div class="mycollectbox" style="padding: 10px 0px">
			        ...
			        <div class="mycollecttable">
			            <table id="tablelist" lay-filter="tablelist"></table><div class="layui-form layui-border-box layui-table-view" lay-filter="LAY-table-1" style=" "><div class="layui-table-box"><div class="layui-table-header"><table cellspacing="0" cellpadding="0" border="0" class="layui-table"><thead><tr><th data-field="0" data-unresize="true"><div class="layui-table-cell laytable-cell-1-0 laytable-cell-checkbox"><input type="checkbox" name="layTableCheckbox" lay-skin="primary" lay-filter="layTableAllChoose"><div class="layui-unselect layui-form-checkbox" lay-skin="primary"><i class="layui-icon layui-icon-ok"></i></div></div></th><th data-field="_send_uid_text"><div class="layui-table-cell laytable-cell-1-_send_uid_text"><span>发送人</span></div></th><th data-field="title"><div class="layui-table-cell laytable-cell-1-title"><span>短信标题</span></div></th><th data-field="_create_time"><div class="layui-table-cell laytable-cell-1-_create_time"><span>收到时间</span></div></th><th data-field="4"><div class="layui-table-cell laytable-cell-1-4" align="center"><span>状态</span></div></th></tr></thead></table></div><div class="layui-table-body layui-table-main"><table cellspacing="0" cellpadding="0" border="0" class="layui-table"><tbody></tbody></table><div class="layui-none">无数据</div></div></div><div class="layui-table-page layui-hide" style=""><div id="layui-table-page1"></div></div><style>.laytable-cell-1-0{ width: 60px; }.laytable-cell-1-_send_uid_text{ width: 230px; }.laytable-cell-1-title{ width: 230px; }.laytable-cell-1-_create_time{ width: 230px; }.laytable-cell-1-4{ width: 200px; }</style></div>
			        </div>
			</div> 
			<div class="common-table-box">
							<div class="layui-btn-group" style="bottom: 5px;">
								<button class="layui-btn layui-btn-sm layui-btn-normal" data-type="del">删除选中</button>
								<button class="layui-btn layui-btn-sm layui-btn-danger" data-type="delAll">全部删除</button>
							</div>
