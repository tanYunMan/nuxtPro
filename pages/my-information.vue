  ...
  <div>
    ...
    <div class="common-container usercenter-container">
      ...
      <div class="usercenter-box">
        <div class="common-usercenter-box" style="margin-bottom: 10px;">
          <h6 class="common-title">账户资料</h6>
          <div class="myorderbox common-form-set">
            <form action="" class="layui-form" onsubmit="return false;">
              <div class="layui-form-item">
                <label class="layui-form-label">客户编号</label>
                <div class="layui-input-inline" style="width:300px;">
                  <input type="text" :value="user.localUserID" class="layui-input layui-disabled" readonly="" disabled="">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">登录名</label>
                <div class="layui-input-inline" style="width:300px;">
                  <input type="text" :value="user.login" class="layui-input layui-disabled" readonly="" disabled="">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">用户名</label>
                <div class="layui-input-inline" style="width:300px;">
                  <input type="text" :value="user.userName" class="layui-input layui-disabled" readonly="" disabled="">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">注册时间</label>
                <div class="layui-input-inline" style="width:300px;">
                  <input type="text" :value="user.regTime" class="layui-input layui-disabled" readonly="" disabled="">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">注册地址</label>
                <div class="layui-input-inline" style="width:300px;">
                  <input type="text" :value="user.userArea" class="layui-input layui-disabled" readonly="" disabled="">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">联系Q Q</label>
                <div class="layui-input-inline" style="width:300px;">
                  <input type="text" :value="user.qq" class="layui-input layui-disabled" readonly="" disabled="">
                </div>
                <button v-if="user.isQq" class="layui-btn layui-btn-sm" @click="unbindQQ">解除绑定</button>
                <span v-else>尚未绑定</span>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">微信</label>
                <div class="layui-input-inline" style="width:300px;">
                  <input type="text" :value="user.wx" class="layui-input layui-disabled" readonly="" disabled="">
                </div>
                <button class="layui-btn layui-btn-sm">解除绑定微信</button>
                <span>尚未绑定微信</span>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">联系地址</label>
                <div class="layui-input-inline" style="width:300px;">
                  <input type="text" :value="user.address" class="layui-input layui-disabled" readonly="" disabled="">
                </div>
              </div>
            </form>
          </div>
      ...
      <div class="usercenter-box">
        <div class="common-usercenter-box">
          <h6 class="common-title">安全管理</h6>
          <div class="common-table-box">
            <button  @click="$refs.pwd.show()" class="layui-btn layui-btn-sm" style="padding: 0px 16px; margin:0px 10px">修改登录密码</button>

                <button class="layui-btn layui-btn-sm" @click="$refs.tpwd.show()" style="padding: 0px 16px; margin:0px 10px">
                  修改交易密码
                </button>
              <button class="layui-btn layui-btn-sm" @click="$refs.log.show()" style="padding: 0px 16px; margin:0px 10px">
                查看登录日志
              </button>


            <password-dialog ref="pwd"></password-dialog>
            <trade-password-dialog
              ref="tpwd"
              :has-trade-pwd="hasTradePwd"
            ></trade-password-dialog>
            <login-log-dialog ref="log"></login-log-dialog>
...
import TradePasswordDialog from '@/components/dialog/tradePassword'
import LoginLogDialog from '@/components/dialog/loginLog'
