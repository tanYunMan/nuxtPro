<template>
  <div>
    ...
    <section>
      <h4><i class="el-icon-user"></i>账户资料</h4>
      <ul>
        <li>
          <span>客户编号：</span>
          <span>{{ user.localUserID }}</span>
        </li>
        <li>
          <span>登录名：</span>
        ...
        <!-- <li>
          <span>管理账户：</span>
          <el-button @click="$refs.account.show()">修改账户资料</el-button> -->
        <account-dialog ref="account"></account-dialog>
        <!-- </li> -->
      </ul>
      <h4><i class="el-icon-link"></i>第三方服务</h4>
      <ul>
        <li>
          <span>绑定QQ：</span>
          <span v-if="user.isQq"
      ...
      <h4><i class="el-icon-lock"></i>安全管理</h4>
      <div>
        <el-button @click="$refs.pwd.show()">修改登录密码</el-button>
        <el-button @click="$refs.tpwd.show()">修改交易密码</el-button>
        <el-button @click="$refs.log.show()">查看登录日志</el-button>
      ...
      <!-- <h4><i class="el-icon-sunrise"></i>服务开通</h4>
      <div>普及版 专业版 旗舰版</div> 
