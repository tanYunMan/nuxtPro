<template>
  ...
  <div class="kystop-bar">
    <div class="kysheader-box">
      ...
      <div class="kystop-r-menu">
        <ul class="kysfix">
          <li class="kyskyst-item"><a href="/my-order">我的订单</a></li>
          <li class="kyskyst-item"><a href="/list-complaints">我的投诉</a></li>
          <li class="kyst-item"><a href="/charge2" class="topchongzhi layui-btn">充值</a></li>
          <li class="kyskyst-item"><a href="/support2" class="topkf" style="border-left: 1px solid #999;">联系客服</a></li>
          <li class="kyst-item" style="padding: 0 1px;"><a href="/personal-center" class="topkf" style="padding: 0 1px;">个人中心</a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="common-header">
    <div class="common-container header-box">
      <a href="/">
        <img :srcset="site.logo" alt="网站logo图片" title="" class="logoimg">
      </a>

      <ul>
        <li class="header-nav-active"><a href="/">首页</a></li>
        <li><a href="/show-list">商品目录</a></li>
        <li><a href="/support2">客服中心</a></li>
        <li><a href="/notice1">最新公告</a></li>
        <li><a href="javascript:void(0)">微信花呗无手续费加款</a></li>
      </ul>
    </div>
  </div>
</header>
...
<style lang="scss" scoped>
  ...
  .header-box ul li:hover a:after,
  ...
  .kys-madestyle-search {
    position: absolute;
    right: 0;
    top: 25px;
  }

  .kys-madestyle-search .layui-input-inline {
    float: left;
  }
